...
export const SAMPLE_DATA: MonthlyRow[] = [
  ...
  // opex = grossProfit − ebitda (implied P&L identity)  |  payroll ≈ opex × 0.65
  { month: "Jan 2024", salesOrders: 4.2, revenue: 3.8, grossProfit: 1.33, ebitda: 0.57, freeCashFlow: 0.28, operatingFreeCashFlow: 0.37, accountsReceivable: 5.70, accountsPayable: 1.60, inventory: 0.76, opex: 0.76, payroll: 0.49 },
  { month: "Feb 2024", salesOrders: 4.5, revenue: 4.1, grossProfit: 1.48, ebitda: 0.66, freeCashFlow: 0.33, operatingFreeCashFlow: 0.43, accountsReceivable: 6.15, accountsPayable: 1.70, inventory: 0.82, opex: 0.82, payroll: 0.53 },
  { month: "Mar 2024", salesOrders: 5.1, revenue: 4.6, grossProfit: 1.70, ebitda: 0.87, freeCashFlow: 0.44, operatingFreeCashFlow: 0.57, accountsReceivable: 6.90, accountsPayable: 1.90, inventory: 0.92, opex: 0.83, payroll: 0.54 },
  { month: "Apr 2024", salesOrders: 4.8, revenue: 5.0, grossProfit: 1.80, ebitda: 0.90, freeCashFlow: 0.45, operatingFreeCashFlow: 0.59, accountsReceivable: 7.50, accountsPayable: 2.10, inventory: 1.00, opex: 0.90, payroll: 0.59 },
  { month: "May 2024", salesOrders: 5.3, revenue: 5.2, grossProfit: 1.87, ebitda: 0.94, freeCashFlow: 0.47, operatingFreeCashFlow: 0.61, accountsReceivable: 7.80, accountsPayable: 2.16, inventory: 1.04, opex: 0.93, payroll: 0.60 },
  { month: "Jun 2024", salesOrders: 5.8, revenue: 5.5, grossProfit: 2.03, ebitda: 1.05, freeCashFlow: 0.53, operatingFreeCashFlow: 0.68, accountsReceivable: 8.25, accountsPayable: 2.28, inventory: 1.10, opex: 0.98, payroll: 0.64 },
  { month: "Jul 2024", salesOrders: 5.2, revenue: 5.8, grossProfit: 2.09, ebitda: 1.04, freeCashFlow: 0.52, operatingFreeCashFlow: 0.68, accountsReceivable: 8.70, accountsPayable: 2.40, inventory: 1.16, opex: 1.05, payroll: 0.68 },
  { month: "Aug 2024", salesOrders: 6.1, revenue: 6.0, grossProfit: 2.22, ebitda: 1.14, freeCashFlow: 0.57, operatingFreeCashFlow: 0.74, accountsReceivable: 9.00, accountsPayable: 2.48, inventory: 1.20, opex: 1.08, payroll: 0.70 },
  { month: "Sep 2024", salesOrders: 6.4, revenue: 6.3, grossProfit: 2.33, ebitda: 1.20, freeCashFlow: 0.60, operatingFreeCashFlow: 0.78, accountsReceivable: 9.45, accountsPayable: 2.60, inventory: 1.26, opex: 1.13, payroll: 0.73 },
  { month: "Oct 2024", salesOrders: 6.0, revenue: 6.1, grossProfit: 2.26, ebitda: 1.16, freeCashFlow: 0.58, operatingFreeCashFlow: 0.75, accountsReceivable: 9.15, accountsPayable: 2.52, inventory: 1.22, opex: 1.10, payroll: 0.72 },
  { month: "Nov 2024", salesOrders: 6.7, revenue: 6.5, grossProfit: 2.41, ebitda: 1.24, freeCashFlow: 0.62, operatingFreeCashFlow: 0.81, accountsReceivable: 9.75, accountsPayable: 2.68, inventory: 1.30, opex: 1.17, payroll: 0.76 },
  { month: "Dec 2024", salesOrders: 7.1, revenue: 6.8, grossProfit: 2.52, ebitda: 1.29, freeCashFlow: 0.65, operatingFreeCashFlow: 0.84, accountsReceivable: 10.20, accountsPayable: 2.80, inventory: 1.36, opex: 1.23, payroll: 0.80 },
];
